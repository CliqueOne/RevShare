...
interface AdminReferrerQRModalProps {
  referralCode: string;
  referrerName: string;
  onClose: () => void;
}

export function AdminReferrerQRModal({ referralCode, referrerName, onClose }: AdminReferrerQRModalProps) {
    ...
    >
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] flex flex-col relative animate-fadeIn">
        ...
        <div className="text-center space-y-4 sm:space-y-6 p-6 sm:p-8 overflow-y-auto">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-1 sm:mb-2">Invite New Referrer</h2>
            <p className="text-sm sm:text-base text-slate-600">
              Share this QR code or link with {referrerName} to complete their registration
            </p>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <p className="text-xs text-slate-600 mb-2 text-left">Signup Link</p>
